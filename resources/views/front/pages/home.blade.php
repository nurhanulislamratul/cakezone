        ...
        <div class="container">
            <div class="row g-5">
                ...
                <div class="col-lg-12 col-md-6 text-center">
                    <h1 class="text-uppercase text-light mb-4">Quick Order Now</h1>
                    <a href="{{route('order.now')}}" class="btn btn-primary border-inner py-3 px-5">Order Now</a>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="container py-5">
            <div class="row gx-5 justify-content-center">
                <div class="col-lg-7 text-center">
                    ...
                    <a href="{{route('order.now')}}" class="btn btn-primary border-inner py-3 px-5 me-3">Shop Now</a>
